...
the user will receive a new authentication token that will expire timeToLive seconds after the currentTime. 
...
namespace LeetCode.DesignAuthenticationManager;
...
public class AuthenticationManager
{
  ...
  {
    return tokens.Values.Count(t => t > currentTime);
  }
}
