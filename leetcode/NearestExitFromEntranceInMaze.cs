    ...
    while (queue.Any())
    {
      ...
      for (int i = 0; i < len; i++)
      {
        ...
        foreach (var m in moves)
        {
          ...
          if (r2 >= 0 && c2 >= 0 && r2 < maze.Length && c2 < maze[0].Length && maze[r2][c2] == '.')
          {
            // check if exit
            if ((r2 == 0 || c2 == 0 || r2 == maze.Length - 1 || c2 == maze[0].Length - 1) && (r2, c2) != (entrance[0], entrance[1]))
              return steps;
